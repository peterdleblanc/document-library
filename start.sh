...
echo ""
echo "  🌐 Main Application:    http://localhost:10080"
echo "  📚 API Documentation:   http://localhost:10080/docs"
echo "  💾 MinIO Console:       http://localhost:10901"
echo "  🔍 Meilisearch:         http://localhost:10700"
echo ""
echo "Direct service access (for development):"
echo "  - Backend API:          http://localhost:10800"
echo "  - Frontend:             http://localhost:10173"
